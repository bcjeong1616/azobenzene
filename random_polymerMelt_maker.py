...
class RandomPolymerMaker():
    ...
    def __init__(self,Ntotal,nPEO,nAzo,box):#b,
        self.nPEO = nPEO
        self.nAzo = nAzo
        self.num_mon=nPEO+3*nAzo
        self.num_pol = Ntotal
    ...
    def get_frame(self):
        ...
        frame.particles.types = self.types
        ...
        frame.bonds.N = (self.num_mon-1)*self.num_pol                    #THIS IS NEW
