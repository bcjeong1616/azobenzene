...
for input_gsd in input_arr:
    ...
    trans_id = frame.angles.types.index('azo_trans_isomer')
    cis_id = frame.angles.types.index('azo_cis_isomer')

    angleGroups = angleGroups[(angleIds == trans_id)|(angleIds == cis_id)]
    ...
    plt.xlabel(rf'Azobenzene Angle [deg]')
